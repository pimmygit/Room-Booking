...
***************************************************/
define('ROOM_ADMIN_NAME', 'Tina Anderson');
define('ROOM_ADMIN_MAIL', 'TMAnderson@uk.ibm.com');
...
***************************************************/
define('DB_HOST', 'localhost');									# Host name of the database server ("localhost" if on the same server)
define('DB_PORT', '3306');										# Port to connect to the database server
define('DB_NAME', 'sbrooms');									# Name of the database which contains L10N tables
define('DB_USER', 'sbrooms_admin');								# Username to connect as to the database
define('DB_PASS', 'vov486ryp');									# Password to authenticate the user
...
define('LOG_FILE', '/srv/www/sbrooms/logs/sbrooms_system.log');		# Location of the log file
